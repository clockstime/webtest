...
NoticeDTO dto = dao.readReply(bbsno);
%>
<!DOCTYPE html>
<html>
<head>
...
<div class="container mt-3">
  ...
  <form action="replyProc.jsp" method="post">
    ...
    <div class="mb-3 mt-3">
      ...
      <input type="text" class="form-control" id="wname" placeholder="작성자명" name="wname">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input type="password" class="form-control" id="pwd" placeholder="비밀번호" name="passwd">
    </div>
